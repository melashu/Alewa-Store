          ...
          children: [
            ...
            SpeedDialChild(
                ...
                onTap: () async {
                  //
                  var url =
                      'https://www.youtube.com/watch?v=18LCQc70cpY&t=1078s';
                  // var url = 'tel:$phone';
                  if (await canLaunch(url)) {
                    ...
                    children: [
                      ...
                      Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle:
                              Text("Weekly Report", style: Style.mainStyle2),
                          contentPadding: EdgeInsets.symmetric(horizontal: 20),
                          onTap: () {
                            Navigator.of(context)
                                .push(MaterialPageRoute(builder: (context) {
                      ...
                      Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle:
                              Text("Monthly Report", style: Style.mainStyle2),
                          contentPadding: EdgeInsets.symmetric(horizontal: 20),
                          onTap: () {
                            Navigator.of(context)
                                .push(MaterialPageRoute(builder: (context) {
                    ...
                    children: [
                      ...
                      Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle:
                              Text("Membership ", style: Style.mainStyle2),
